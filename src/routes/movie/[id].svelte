<script>
	...
	import { searchMovieWithId, theMovie, loading } from '$lib/stores'
	import { fade } from 'svelte/transition'

	let imageLoading = true

	searchMovieWithId($page.params.id)
...
<div class="container" in:fade>
	...
	{:else}
		<div class="movie-details">
			<div style="background-image: url({requestDifferentSizeImage($theMovie.Poster)});"
				class="poster">
				{#if imageLoading}
					<Loader 
						scale='.7'
